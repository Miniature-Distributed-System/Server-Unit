...
class Log{
    ...
    public:
        ...
        template<typename... Args>
        void senderCoreInfo(std::string fun_name, Args... args){
            std::ostringstream ostring;
            ostring << colorCoder(currentDateTime(), ALL, FG_YELLLOW, BG_DARKGREY) << 
                colorCoder(" I ", BOLD, FG_GREEN, BG_DEFAULT) <<
        ...
        template<typename... Args>
        void pktProcessorInfo(std::string fun_name, Args... args){
            std::ostringstream ostring;
            ostring << colorCoder(currentDateTime(), ALL, FG_YELLLOW, BG_DARKGREY) << 
                colorCoder(" I ", BOLD, FG_GREEN, BG_DEFAULT) <<
                colorCoder(fun_name, BOLD, FG_BLUE, BG_DEFAULT) <<
                colorCoder(": " + DEBUG(args...).str(), ALL, FG_BLUE, BG_DEFAULT) << std::endl;
            std::cout << ostring.str();
        };
